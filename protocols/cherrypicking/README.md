...
* `Drop Inactive Pipette Tip (default = Yes)`: Safety setting to avoid contamination. Specify if you'll drop tip on the pipette when the other pipette is in use. `Mode` overides this parameter.
